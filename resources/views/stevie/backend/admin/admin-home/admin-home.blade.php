                                    ...
                                    <tr>
                                        <td>
                                            <h2 class="table-avatar">
                                                <a href="javascript:void(0);" class="avatar"><img src="assets-back/img/products/image-7.png" alt=""></a>
                                                <a href="javascript:void(0);">{{ $value["shop_name"] }}<span>{{ $value["shop_phone"] }}</span></a>
                                            </h2>
                                        </td>
