...
@section('content')
    <!-- Conditions generales d'utilisation pro Section Begin -->
                ...
                <div class="row">
                    <div class="col-lg-12 text-center">
                        <div class="banniereHeader">
                            <h2>Conditions Générales d’utilisation Pro</h2>
                        </div>
                    </div>
                    <div class="col-lg-12">
                                                        ...
                                                        <div class="product__details__tab__desc">
                                                            ...
                                                            <p>
                                                               ...
                                                               <b>Conditions d’inscription </b><br><br>
                                                                ...
                                                                Lors de son inscription, l’utilisateur choisit un identifiant (son adresse email) et un mot de passe (ci-après « les identifiants ») qui lui permettent de se connecter à la plateforme pour accéder aux services réservés et aux informations de son compte.
                                                                 <br><br>
                                                    ...
                                                    <div class="product__details__tab__desc">
                                                        ...
                                                        <p>
                                                            ...
                                                            <ul style="margin-left: 100px;">
                                                                ...
                                                                <li> ne pas mettre en ligne de contenus pouvant porter atteinte aux intérêts de tierces personnes</li><br>
    ...
    <!-- Conditions generales d'utilisation pro Section End -->
@endsection
