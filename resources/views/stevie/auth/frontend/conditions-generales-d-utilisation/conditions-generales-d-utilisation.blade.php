...
@section('content')
    <!-- Conditions generales d'utilisation Section Begin -->
                                                    ...
                                                    <div class="tab-pane active" id="tabs-07" role="tabpanel">
                                                        <div class="product__details__tab__desc">
                                                            ...
                                                            <p>
                                                                ...
                                                                Les services de commandes en ligne, notations des produits, des commerces et publication des avis sont exclusivement réservés aux membres ou clients de la plateforme. Pour devenir membre ou client de la plateforme, l’Utilisateur doit s’inscrire via le formulaire d’inscription et créer un compte. <br><br>

                                                               <b>Conditions d’inscription </b><br><br>
                                                                ...
                                                                Lors de son inscription, l’utilisateur choisit un identifiant (son adresse email) et un mot de passe (ci-après « les identifiants ») qui lui permettent de se connecter à la plateforme pour accéder aux services réservés et aux informations de son compte. <br><br>

                                                                 <b>Confidentialité des identifiants de compte</b><br><br>
                                                                ...
                                                                En cas de perte ou de vol des Identifiants le concernant, l’Utilisateur est responsable de toute conséquence dommageable de cette perte ou ce vol, et doit utiliser, dans les plus brefs délais, la procédure lui permettant de les modifier, qui peut être consultée sur la page accessible à l’adresse https://www.mangeonsafro.com/mon-compte/
                                                                 ...
                                                                 <br><br><b>Recherche, consultation, sélection de produits dans la plateforme</b><br><br>
                                                                ...
                                                                A cette étape, l’utilisateur doit vérifier sa commande et s’assurer qu’il n’y a pas d’erreur dans celle-ci. En l’absence d’erreur, il peut alors valider sa commande via le bouton « commander » ; il est ensuite dirigé vers la page de paiement.
                                                                 ...
                                                                 <br><br><b>Droit de modification et d’annulation</b><br><br>
                                                                ...
                                                                <br><br><b>Suspension de compte</b><br><br>
                                                                ...
                                                                <br><br><b>Désinscription</b><br><br>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="product__details__tab">
                                            <ul class="nav nav-tabs" role="tablist">
                                                ...
                                                <li class="nav-item">
                                                    <a class="nav-link" data-toggle="tab" href="#tabs-14" role="tab"
                                                        aria-selected="false">ARRET</a>
                                                </li>
                                            ...
                                            <div class="tab-content">
                                                <div class="tab-pane active" id="tabs-13" role="tabpanel">
                                                    <div class="product__details__tab__desc">
                                                        <!-- <h6>Condition 10</h6> -->
                                                        <p>Les informations diffusées sur MangeonAfro sont réputées fiables, toutefois, MangeonsAfro ne garantit pas qu’elles soient exemptes de défauts, d’erreurs ou d’omission</p>
                                                    </div>
                                                </div>
                                                <div class="tab-pane" id="tabs-14" role="tabpanel">
                                                    <div class="product__details__tab__desc">
                                                        <!-- <h6>Condition 11</h6> -->
                                                        <p>
                                                            Malgré des mises à jour régulières, MangeonsAfro ne peut être tenu responsable de :
                                                            <ul style="margin-left: 100px;">
                                                                ...
                                                                <li>l’utilisateur aura l’entière responsabilité de l’utilisation qu’il fera du contenu du site ou des informations. Toute utilisation du service par l’utilisateur portant atteinte ou causant des dommages au site fera l’objet d’une indemnisation au profit du site.</li>

                                                                <li>Tout événement ayant pour conséquence un dysfonctionnement du serveur ou du réseau n’engage en rien la responsabilité de MangeonsAfro</li>
                                                                <li>L’accès aux services du site peut à tout moment faire l’objet d’une modification, d’une suspension ou d’une interruption sans préavis pour maintenance ou tout autre cas nécessitant cette situation. L’utilisateur s’engage à ne réclamer aucune indemnisation suite à la modification, à la suspension ou à l’interruption du présent contrat.</li>
                                                                <li>L’utilisateur a la possibilité de contacter le site par mail à l’adresse suivante : contact@mangeonsafro.com</li>
                                                            </ul>
                                        ...
                                        <div class="product__details__tab">
                                            ...
                                            <div class="tab-content">
                                                <div class="tab-pane active" id="tabs-17" role="tabpanel">
                                                    <div class="product__details__tab__desc">
                                                        <!-- <h6>Condition 10</h6> -->
                                                        <p>Les présentes conditions générales d’utilisation constituent un contrat dont la durée est indéterminée, ses effets à l’égard de l’utilisateur entrent en compte dès lors que l’utilisateur a recours au service.</p>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="product__details__tab__desc">
                                                        ...
                                                        <p>
                                                           ...
                                                           <ul style="margin-left: 100px;">
                                                               ...
                                                               <li>  le Contenu est clairement du spam.</li><br>
    ...
    <!-- Conditions generales d'utilisation Section End -->
@endsection
