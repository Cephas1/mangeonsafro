            ...
            <div class="col-lg-2 col-md-6 col-sm-6">
                <div class="footer__about">
                    <div class="footer__about__logo">
                        <a href="/"><img src="assets-front/img/logo.png" style="height: 30px; width: 30px" alt=""></a>
                    </div>
                    <ul>
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 offset-lg-1">
                <div class="footer__widget">
                    ...
                    <ul>
                        ...
                        <li><a href="politique-de-confidentialite">Politique de confidentialité et de cookies</a></li>
                    </ul>
                    <ul>
