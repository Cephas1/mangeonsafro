        ...
        <div class="content container-fluid">
            ...
            <div class="page-header">
                <div class="row align-items-center">
                    <div class="col">
                        <h3 class="page-title">Commerces</h3>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="index">Dashboard</a></li>
                            <li class="breadcrumb-item active">liste commerce</li>
                        </ul>
                    </div>
                    <div class="col-auto float-right ml-auto">
                        <a href="#" class="btn add-btn" data-toggle="modal" data-target="#add_client"><i class="fa fa-plus"></i> Ajouter un Restaurant</a>
                        <div class="view-icons">
                            <a href="commerce" class="grid-view btn btn-link"><i class="fa fa-th"></i></a>
                            <a href="list-commerce" class="list-view btn btn-link active"><i class="fa fa-bars"></i></a>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        <h2 class="table-avatar">
                                            ...
                                            <a href="client-profile">Restaurant01</a>
                                        </h2>
                                    </td>
                                    <td>REST-0001</td>
                                    <td>lorem ipsum</td>
                                ...
                                <tr>
                                    <td>
                                        <h2 class="table-avatar">
                                            <a href="client-profile" class="avatar"><img src="{{ asset("assets-back/img/profiles/avatar-13.jpg") }}" alt=""></a>
                                            <a href="client-profile">Restaurant02</a>
                                        </h2>
                                    </td>
                                    <td>REST-0002</td>
                                    <td>Tressa Wexler</td>
                                ...
                                <tr>
                                    <td>
                                        <h2 class="table-avatar">
                                            ...
                                            <a href="client-profile">Restaurant03</a>
                                        </h2>
                                    </td>
                                    <td>REST-0003</td>
                                    <td>Ruby Bartlett</td>
                                ...
                                <tr>
                                    <td>
                                        <h2 class="table-avatar">
                                            <a href="client-profile" class="avatar"><img alt="" src="/public/assets-back/img/profiles/avatar-13.jpg"></a>
                                            <a href="client-profile">Lorem ipsum</a>
                                        </h2>
                                    </td>
                                    <td>REST-0004</td>
                                    <td>Misty Tison</td>
                                ...
                                <tr>
                                    ...
                                    <td class="text-right">
                                        <div class="dropdown dropdown-action">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                <a class="dropdown-item" href="#" data-toggle="modal" data-target="#edit_client"><i class="fa fa-pencil m-r-5"></i> Modifier</a>
                                                <a class="dropdown-item" href="#" data-toggle="modal" data-target="#delete_client"><i class="fa fa-trash-o m-r-5"></i> Spprimer</a>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
